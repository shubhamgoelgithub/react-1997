...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: `https://protected-tor-53310.herokuapp.com/getrestaurantbyid/${resId}`,
            method: 'GET',
    ...
    handleClick = (state, value) => {
        ...
        if (state === 'orderModalIsOpen') {
            axios({
                url: `https://protected-tor-53310.herokuapp.com/getItemsbyrestaurant/${restaurantId}`,
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            }).then(res => {
    ...
    getData = (data) => {
        return fetch(`https://protected-tor-53310.herokuapp.com/payment`, {
            method: "POST",
            headers: {
